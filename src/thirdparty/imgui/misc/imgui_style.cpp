...
void ImGui_SetStyle(const ImGuiStyle_t imguiStyle)
{
	...
	default:
	{
		colors[ImGuiCol_Text]                   = ImVec4(0.82f, 0.86f, 0.83f, 1.00f);
		colors[ImGuiCol_TextDisabled]           = ImVec4(0.48f, 0.54f, 0.50f, 1.00f);
		colors[ImGuiCol_TextSelectedBg]         = ImVec4(0.22f, 0.42f, 0.30f, 0.40f);
		colors[ImGuiCol_WindowBg]               = ImVec4(0.10f, 0.12f, 0.11f, 1.00f);
		colors[ImGuiCol_ChildBg]                = ImVec4(0.00f, 0.00f, 0.00f, 0.78f);
		colors[ImGuiCol_PopupBg]                = ImVec4(0.09f, 0.11f, 0.10f, 1.00f);
		colors[ImGuiCol_Border]                 = ImVec4(0.30f, 0.42f, 0.34f, 0.45f);
		colors[ImGuiCol_BorderShadow]           = ImVec4(0.04f, 0.04f, 0.04f, 0.00f);
		colors[ImGuiCol_FrameBg]                = ImVec4(0.00f, 0.00f, 0.00f, 0.78f);
		colors[ImGuiCol_FrameBgHovered]         = ImVec4(0.08f, 0.12f, 0.09f, 1.00f);
		colors[ImGuiCol_FrameBgActive]          = ImVec4(0.10f, 0.16f, 0.12f, 1.00f);
		colors[ImGuiCol_TitleBg]                = ImVec4(0.16f, 0.26f, 0.20f, 1.00f);
		colors[ImGuiCol_TitleBgActive]          = ImVec4(0.20f, 0.32f, 0.24f, 1.00f);
		colors[ImGuiCol_TitleBgCollapsed]       = ImVec4(0.00f, 0.00f, 0.00f, 1.00f);
		colors[ImGuiCol_MenuBarBg]              = ImVec4(0.09f, 0.11f, 0.10f, 1.00f);
		colors[ImGuiCol_ScrollbarBg]            = ImVec4(0.12f, 0.15f, 0.13f, 1.00f);
		colors[ImGuiCol_ScrollbarGrab]          = ImVec4(0.22f, 0.34f, 0.26f, 1.00f);
		colors[ImGuiCol_ScrollbarGrabHovered]   = ImVec4(0.28f, 0.44f, 0.33f, 1.00f);
		colors[ImGuiCol_ScrollbarGrabActive]    = ImVec4(0.32f, 0.50f, 0.38f, 1.00f);
		colors[ImGuiCol_CheckMark]              = ImVec4(0.52f, 0.74f, 0.58f, 1.00f);
		colors[ImGuiCol_SliderGrab]             = ImVec4(0.26f, 0.42f, 0.32f, 1.00f);
		colors[ImGuiCol_SliderGrabActive]       = ImVec4(0.34f, 0.54f, 0.40f, 1.00f);
		colors[ImGuiCol_Button]                 = ImVec4(0.20f, 0.32f, 0.24f, 1.00f);
		colors[ImGuiCol_ButtonHovered]          = ImVec4(0.26f, 0.42f, 0.32f, 1.00f);
		colors[ImGuiCol_ButtonActive]           = ImVec4(0.30f, 0.48f, 0.36f, 1.00f);
		colors[ImGuiCol_Header]                 = ImVec4(0.20f, 0.32f, 0.24f, 1.00f);
		colors[ImGuiCol_HeaderHovered]          = ImVec4(0.26f, 0.42f, 0.32f, 1.00f);
		colors[ImGuiCol_HeaderActive]           = ImVec4(0.30f, 0.48f, 0.36f, 1.00f);
		colors[ImGuiCol_Separator]              = ImVec4(0.28f, 0.38f, 0.32f, 0.35f);
		colors[ImGuiCol_SeparatorHovered]       = ImVec4(0.36f, 0.52f, 0.40f, 0.70f);
		colors[ImGuiCol_SeparatorActive]        = ImVec4(0.42f, 0.60f, 0.46f, 1.00f);
		colors[ImGuiCol_ResizeGrip]             = ImVec4(0.40f, 0.58f, 0.46f, 0.30f);
		colors[ImGuiCol_ResizeGripHovered]      = ImVec4(0.40f, 0.58f, 0.46f, 0.60f);
		colors[ImGuiCol_ResizeGripActive]       = ImVec4(0.40f, 0.58f, 0.46f, 0.90f);
		colors[ImGuiCol_Tab]                    = ImVec4(0.16f, 0.26f, 0.20f, 1.00f);
		colors[ImGuiCol_TabHovered]             = ImVec4(0.26f, 0.42f, 0.32f, 1.00f);
		colors[ImGuiCol_TabActive]              = ImVec4(0.24f, 0.38f, 0.29f, 1.00f);
		colors[ImGuiCol_TabUnfocused]           = ImVec4(0.12f, 0.16f, 0.13f, 1.00f);
		colors[ImGuiCol_TabUnfocusedActive]     = ImVec4(0.16f, 0.24f, 0.18f, 1.00f);
		colors[ImGuiCol_TableHeaderBg]          = ImVec4(0.13f, 0.18f, 0.15f, 1.00f);
		colors[ImGuiCol_TableBorderStrong]      = ImVec4(0.20f, 0.28f, 0.22f, 1.00f);
		colors[ImGuiCol_TableBorderLight]       = ImVec4(0.18f, 0.24f, 0.20f, 1.00f);
		colors[ImGuiCol_TableRowBg]             = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
		colors[ImGuiCol_TableRowBgAlt]          = ImVec4(0.16f, 0.20f, 0.17f, 0.18f);
		colors[ImGuiCol_NavHighlight]           = ImVec4(0.34f, 0.54f, 0.40f, 1.00f);
		colors[ImGuiCol_ModalWindowDimBg]       = ImVec4(0.04f, 0.06f, 0.05f, 0.55f);
