...
struct MaterialGlue_s
{
	...
	// Sampler-state indices; required for correct texture tiling.
	byte samplers[MATERIAL_SAMPLER_COUNT];
...
class VMaterialGlue : public IDetour
{
	...
	virtual void GetFun(void) const
	{
		...
		if (!v_GetMaterialAtCrossHair)
			Warning(eDLL_T::MS, "[BRIDGE-MATERIAL] CMaterialGlue::GetMaterialAtCrossHair pattern unresolved\n");
	}
