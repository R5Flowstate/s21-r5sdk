...
// Talks to the Discord client over discord-ipc-N named pipes directly.
...
public:
	...
	static void UpdateHandlers(DiscordEventHandlers* handlers);
	static bool IsConnected(void);

private:
	static bool Connect(void);
	static void Disconnect(void);
	static bool SendHandshake(void);
