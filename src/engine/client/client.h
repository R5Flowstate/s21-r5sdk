...
public:
	...
	inline PlatformUserId_t GetPlatformUserId(void) const { return m_nPlatformUserId; }
	...
	inline void SetPlatformUserId(PlatformUserId_t nPlatformUserId) { m_nPlatformUserId = nPlatformUserId; }
...
private:
	...
	int unk0;
	PlatformUserId_t m_nPlatformUserId;
	int unk1;
	int unk2;
	int m_nDeltaTick;
...
public:
	...
	inline void Reset(void)
	{
		...
		m_flScriptExecQuotaTimeStart = 0.0;
		m_nScriptExecQuotaCount = NULL;
...
private:
	...
	// Same, narrowed to the exec-family verbs (sv_quota_scriptExecsPerSecond).
	double m_flScriptExecQuotaTimeStart;
	int m_nScriptExecQuotaCount;
...
public:
	...
	inline void Reset(void)
	{
		...
		m_flScriptExecQuotaTimeStart = 0.0;
		m_nScriptExecQuotaCount = NULL;
		m_nBridgeStrCmdSeqHigh = 0;
		m_nBridgeStrCmdSeenMask = 0;
		m_nBridgeRelSeqHigh = 0;
		m_nBridgeRelSeenMask = 0;
		m_flMovementTimeForUserCmdProcessingRemaining = 0.0f;
		m_bInitialConVarsSet = false;
...
public: // Inlines
	...
	bool AcceptBridgeRelSeq(uint32_t nSeq);

	void SetBridgeRttReport(float flSeconds, double flNow)
	{
		m_flBridgeRtt = flSeconds;
		m_flBridgeRttTime = flNow;
		m_bBridgeRttValid = true;
	}
	bool HasBridgeRttReport(void) const { return m_bBridgeRttValid; }
...
private:
	...
	double m_flScriptExecQuotaTimeStart;
	int m_nScriptExecQuotaCount;
	uint32_t m_nBridgeStrCmdSeqHigh;   // highest bridge seq seen (0 = none yet)
	uint64_t m_nBridgeStrCmdSeenMask;  // bit i = (seqHigh - i) seen, bit 0 = seqHigh
	uint32_t m_nBridgeRelSeqHigh;      // ScriptRemote/chat seq window
	uint64_t m_nBridgeRelSeenMask;
