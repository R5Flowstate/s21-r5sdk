...
public:
	...
	inline CNetworkStringTable* GetInstanceBaselineTable(void) const { return m_pInstanceBaselineTable; }
...
class VServer : public IDetour
{
	...
	virtual void GetFun(void) const
	{
		// VConnectPasswordGate resolves the same ConnectClient target for
