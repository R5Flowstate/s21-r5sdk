...
struct SQRefCounted
{
	...
	// VM context index into s_perVmScriptMemUsage (SQWeakRef::Release).
	SQInteger _context;
...
#define tofloat(num) ((sq_type(num)==SQ_S21_OT_INTEGER)?(SQFloat)_integer(num):_float(num))
#define tointeger(num) ((sq_type(num)==SQ_S21_OT_FLOAT)?(SQInteger)_float(num):_integer(num))
/////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////
...
struct SQObjectPtr : public SQObject
{
	...
	// Zero the 8-byte union before nInteger: engine == compares all 8 bytes.
	SQObjectPtr(bool bBool)
	{
		_type = OT_BOOL;
		_pad = NULL;
