...
// S21 type flags live in the top nibble (0xF0000000), not bits 24-27.
// NUMERIC is 0x40000000 here; CANBEFALSE is off the integer/float tags.
#define SQOBJECT_REF_COUNTED 0x80000000
#define SQOBJECT_NUMERIC		0x40000000
#define SQOBJECT_DELEGABLE		0x20000000
#define SQOBJECT_CANBEFALSE		0x10000000
...
typedef enum tagSQObjectType
{
	...
	OT_INTEGER =		(_RT_INTEGER|SQOBJECT_NUMERIC),		// 0x40000002, live
	OT_FLOAT =			(_RT_FLOAT|SQOBJECT_NUMERIC),		// 0x40000004, live
...
typedef struct tagSQObject
{
	...
	// _pad is SQVector3D.x (the 4-byte gap before 8-aligned _unVal); Y/Z live in _unVal.
	SQInteger _pad;
...
#define sq_isnumeric(o) (((o)._type & SQ_S21_NUMERIC_MASK) != 0)
...
class VSquirrelAPI : public IDetour
{
	...
	virtual void GetFun(void) const
	{
		...
		// OT_ARRAY S21=0x80000040. The tail through the tag write is what makes
		// this unique: a sibling sq_new* is byte-identical up to there but
		// tags 0x80200000.
		Module_FindPattern(g_GameDll, "48 89 5C 24 08 57 48 83 EC 20 48 8B D9 48 8B 49 50 E8 ?? ?? ?? ?? 48 8B F8 FF 40 10 8B 53 68 8D 42 01 48 C1 E2 04 48 03 53 78 89 43 68 FF 47 10 83 3A 00 7D 23 48 8B 4A 08 C7 02 40 00 00 80").GetPtr(v_sq_newarray);
		if (!v_sq_newarray)
