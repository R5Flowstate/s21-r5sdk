...
#define SDK_VERSION "R5FlowstateSDK003" // Increment this with every /breaking/ SDK change (i.e. security/backend changes breaking compatibility).
#define SDK_DISPLAY_VERSION "1.1.0" // Player-facing product label. Not the wire gate.
