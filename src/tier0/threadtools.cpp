...
// S21 does not export ThreadInMainThread / ThreadInServerFrameThread; local storage until resolved.
static ThreadId_t s_MainThreadID = GetCurrentThreadId();
static ThreadId_t s_ServerFrameThreadID = 0;
ThreadId_t* g_ThreadMainThreadID = &s_MainThreadID;
ThreadId_t* g_ThreadServerFrameThreadID = &s_ServerFrameThreadID;
#else // !CLIENT_DLL
//===== Copyright © 1996-2005, Valve Corporation, All rights reserved. ======//
//
// Purpose: Thread tools
