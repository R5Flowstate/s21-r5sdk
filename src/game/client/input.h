...
public:
	virtual void Unknown_InputVTableSlot0() = 0;
	virtual void Unknown_InputVTableSlot1() = 0;
	virtual void Unknown_InputVTableSlot2() = 0;

	virtual int GetMaxAbilityBindingCount( void ) = 0;
	virtual int GetMaxAbilityBindingLength( void ) = 0;

	virtual void Unknown_InputVTableSlot3() = 0;
	...
	virtual void Unknown_InputVTableSlot4() = 0;
