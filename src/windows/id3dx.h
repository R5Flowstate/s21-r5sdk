...
IDXGISwapChain* Dx12_GetGameSwapChain();
...
extern bool LoadTextureBuffer(unsigned char* buffer, int len, ID3D11ShaderResourceView** out_srv, int* out_width, int* out_height,
	uint64_t* out_imgui_texture_id = nullptr, ID3D12Resource** out_dx12_texture = nullptr, ID3D12Resource** out_dx12_upload = nullptr);
